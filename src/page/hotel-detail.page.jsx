...
const Hotel = () => {
    ...
    if (isError){
        return <div className="flex items-center justify-center text-red-500 h-screen"><p className="text-red-500 text-lg"> Error  {error.message}</p></div>
    }
                ...
                <div className="flex flex-col lg:flex-row gap-4  px-4 mt-10 pb-5  ">
                  {/*HOTEL IMAGE*/}
                    <div className="relative   " >
                            ...
                            <img src={hotel?.image} className="object-contain md:object-cover  h-auto rounded-md" />


                        <div className="flex gap-2 mt-4 ">
                            <span className="bg-gray-100  p-2 rounded-xl capitalize text-sm  font-semibold ">rooftop view</span>
                            <span className="bg-gray-100  p-2 rounded-xl capitalize text-sm font-semibold">french cusine</span>
                            <span className="bg-gray-100  p-2 rounded-xl capitalize text-sm font-semibold">city center</span>
                        </div>
                    ...
                    <div className="flex flex-col max-w-[700px]" >
                      <h1 className="text-2xl font-bold ">{hotel?.name}</h1>
                        <div className="flex items-center gap-2 mt-2 mb-4">
                            ...
                            <p className="text-gray-500 font-light capitalize ">{hotel?.city}</p>
                        </div>
                        ...
                        <div className="flex items-center space-x-1 mb-5">
                            ...
                            <span className="text-gray-500 font-light ">({hotel?.review?.toLocaleString() ?? "No"} reviews)</span>
                        </div>
